package com.jhtacybercampus.web.controller.student.notice;
...
@WebServlet("/student/notice/list")
public class ListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("../../WEB-INF/view/student/notice/list.jsp").forward(req, resp);
	}
